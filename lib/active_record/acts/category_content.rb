    ...
    module CategoryContent
      ...
      module ClassMethods
        ...
        def acts_as_category_content(options = {})
          ...
          configuration = { :category => 'categories', :counter_cache => 'pictures_count', :through => 'category_documents' }
          configuration.update(options) if options.is_a?(Hash)
          
          has_many configuration[:through]
          has_many configuration[:category], :through => configuration[:through]
